...
type UpdateContinuousMonitoringRequest struct {
	ContinuousMonitoring *shared.ContinuousMonitoring `request:"mediaType=application/json"`
...
type UpdateContinuousMonitoringResponse struct {
	ContentType string
	StatusCode  int
