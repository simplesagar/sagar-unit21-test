...
type AddVerificationResultToEntityRequest struct {
	LinkVerificationResult *shared.LinkVerificationResult `request:"mediaType=application/json"`
...
type AddVerificationResultToEntityResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// OK
	LinkVerificationResponse *shared.LinkVerificationResponse
}
